const handleHTTPErrorMessage = (error) => {
  ...
  switch (error) {
    ...
    case 303:
      message =
        "Redirects do not link to the requested resource itself, but to another page";
      break;
    case 304:
    ...
    case 305:
      message =
        "The resource requested by the client is only available through a proxy";
      break;
    case 307:
    ...
    case 402:
      message =
        "The request cannot be processed until the customer makes a payment";
      break;
    case 403:
    ...
    case 404:
      message =
        "We were unable to find the resource you are looking for. Try again";
      break;
    case 405:
    ...
    case 411:
      message =
        "The server refused to accept the request without a Content-Length header set";
      break;
    case 412:
    ...
    case 417:
      message =
        "The expectation provided in the Expect header of the request could not be met.";
      break;
    case 418:
    ...
    case 422:
      message =
        "The request was well worded but could not be followed up due to errors in the form.";
      break;
    case 423:
    ...
    case 451:
      message =
        "The user agent has requested a feature that cannot legally be provided.";
      break;
    case 500:
    ...
    case 511:
      message =
        "The client needs to authenticate to gain access to the network.";
      break;
  }
